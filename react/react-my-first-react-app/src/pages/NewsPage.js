            ...
            <section className="video-section">
              ...
              <div className="video-list">
                <div className="video-wrapper">
                  ...
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/Rz6bswWbPqw?si=0Je3Y085kS2QibIg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                </div>
              ...
              <a href="/#" className="large-link">Visi video</a>
          ...
          <aside>
            ...
            <section className="events-section">
              ...
              <div className="events-list">
                ...
                <div className="event-item">
                  <a href="/#">
                    <div classNamess="event-item-content-wrapper">
                      <div classNamess="event-date">
                        <span classNamess="event-day">30</span>
                        <span classNamess="event-month">Geg</span>
                      </div>
                      <div classNamess="event-item-content">
                        <span classNamess="event-location">Upės g. 21, Greenhall 1, 10 aukštas ir Online </span>
                        <h3 classNamess="event-title">CodeAcademy galimybės verslui</h3>
                      </div>
                    </div>
                  </a>
                </div>
              ...
              <a href="/#" classNamess="large-link">Daugiau</a>
            </section>
          </aside>
        </div>
      </div>
